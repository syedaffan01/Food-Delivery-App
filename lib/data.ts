const dummyData = {
    ...
    customizations: [
        ...
        // Sides
        { name: "Coke", price: 30, type: "sides" },
        { name: "Fries", price: 35, type: "sides" },
        { name: "Garlic Bread", price: 40, type: "sides" },
        { name: "Chicken Nuggets", price: 50, type: "sides" },
        { name: "Iced Tea", price: 28, type: "sides" },
        { name: "Salad", price: 33, type: "sides" },
        { name: "Potato Wedges", price: 38, type: "sides" },
        { name: "Mozzarella Sticks", price: 45, type: "sides" },
        { name: "Sweet Corn", price: 25, type: "sides" },
        { name: "Choco Lava Cake", price: 42, type: "sides" },
    ],
